...
<form id="postForm" method="post" action="insert.php" enctype="multipart/form-data">
   <fieldset>
    <legend>点検項目入力</legend>
     <label>路線名<br>
      ...
      <label>駅名<br>
        ...
        <label>詳細な場所<br><input type="text" name="place" placeholder='例）上りホーム4号車1番ドア前天井' style="width:300px;" value="aaa"></label><br>
        <label>損傷内容<br><input type="text" name="detail" placeholder='例）漏水' value="aaa"></label><br>
        <label>数量<br><input type="text" name="quantity" placeholder='例）1・複数' value="aaa"></label><br>
        <label>管理者<br>
        <select name="whose">
              <!-- <option value="" selected disabled>選択してください</option> -->
        ...
        <label>備考欄・進捗<br><textArea name="remarks" rows="3" cols="40" placeholder='天井から2秒毎滴下・お客様への影響がないため通常対応とする'>aaa</textArea></label><br>
